...
def main():
    ...
    # Determine the current date and required suffix.
    ...
    if todays_date.day in day_suffix.keys():
        day_suffix = day_suffix[todays_date.day]
    else:
        day_suffix = 'th'

    displayed_date = todays_date.strftime('%B %d')
    displayed_date = displayed_date + day_suffix + ', ' + str(todays_date.year)

    timestamp_border = ''
    
    for _ in range(len(displayed_date)):
        timestamp_border += '-'

    # Create the header information that will be written at the top of the file.
...
// ----------------------------------------------------------------\n'
    ...
    header_timestamp = '\
// ------------------------------------------------' + timestamp_border + '\n\
// TIMESTAMP: This file was last autogenerated on ' + displayed_date + '.\n\
// ------------------------------------------------' + timestamp_border + '\n'

    # Create the source file that contains the top 50 songs.
